...
if __name__ == "__main__":
    ...
    if os.path.exists(exp_path):  # we are resuming old training
        print("resuming training")
        model_path = os.path.join(exp_path, "model_resume.p")
        buffer_path = os.path.join(exp_path, "buffer_resume.p")
    else:
        model_path = None
        buffer_path = None
