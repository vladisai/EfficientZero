...
def _log(
    ...
    if vis_result:
        (
            ...
            target_value_prefix,
            target_value,
            trans_target_value_prefix,
            trans_target_value,
            target_value_prefix_phi,
            target_value_phi,
            pred_value_prefix,
            pred_value,
            target_policies,
    ...
    (
        ...
        [
            replay_buffer.episodes_collected.remote(),
    ...
    if summary_writer is not None:
        ...
        if vis_result:
            summary_writer.add_histogram(
                "{}_replay_data/replay_buffer_priorities".format(tag),
                priorities,
                step_count,
            )
            summary_writer.add_histogram(
            ...
            summary_writer.add_scalar(
                "{}_statistics/new_priority_mean".format(tag),
                new_priority.mean(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/new_priority_std".format(tag),
                new_priority.std(),
                step_count,
            )

            summary_writer.add_scalar(
                "{}_statistics/target_value_prefix_mean".format(tag),
                target_value_prefix.mean(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/target_value_prefix_std".format(tag),
                target_value_prefix.std(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/pre_value_prefix_mean".format(tag),
                pred_value_prefix.mean(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/pre_value_prefix_std".format(tag),
                pred_value_prefix.std(),
                step_count,
            )

            summary_writer.add_scalar(
                "{}_statistics/target_value_mean".format(tag),
                target_value.mean(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/target_value_std".format(tag),
                target_value.std(),
                step_count,
            )
            summary_writer.add_scalar(
                "{}_statistics/pre_value_mean".format(tag),
                pred_value.mean(),
                step_count,
            )
            summary_writer.add_scalar(
            ...
            summary_writer.add_histogram(
                "{}_data_dist/target_value_prefix".format(tag),
                target_value_prefix - 1e-5,
                step_count,
            )
            summary_writer.add_histogram(
            ...
            summary_writer.add_histogram(
                "{}_data_dist/transformed_target_value_prefix".format(tag),
                trans_target_value_prefix,
                step_count,
            )
            summary_writer.add_histogram(
                "{}_data_dist/transformed_target_value".format(tag),
                trans_target_value,
                step_count,
            )
            summary_writer.add_histogram(
                "{}_data_dist/pred_value_prefix".format(tag),
                pred_value_prefix - 1e-5,
                step_count,
            )
            summary_writer.add_histogram(
            ...
            summary_writer.add_histogram(
                "{}_data_dist/pred_policies".format(tag),
                predicted_policies.flatten(),
                step_count,
            )
            summary_writer.add_histogram(
                "{}_data_dist/target_policies".format(tag),
                target_policies.flatten(),
                step_count,
            )
        ...
        summary_writer.add_scalar(
            "{}/value_prefix_loss".format(tag), value_prefix_loss, step_count
        )
        summary_writer.add_scalar(
            "{}/consistency_loss".format(tag), consistency_loss, step_count
        )
        summary_writer.add_scalar(
            "{}/episodes_collected".format(tag), replay_episodes_collected, step_count
        )
        summary_writer.add_scalar(
